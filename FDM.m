...
ylabel('magnitude'); 
z=z1+z2; 
% freqency multiplexing figure; 
plot(z); 
title('frequency multiplexed signals'); 
% freqency demultiplexing figure; 
f1=[ones(10,1); 
zeros(182,1); 
ones(10,1)]; 
%applying filter for signal 1 dz1=z.*f1; 
d1 = ifft(dz1);  
...
ones(182,1); 
zeros(10,1)]; 
% applying filter for signal 2 dz2=z.*f2; 
d2 = ifft(dz2); 
subplot(2,1,2) 
plot(t*100,d2); 
